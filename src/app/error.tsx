...
export default function Error({
  ...
  return (
    <div className="min-h-[calc(100svh-80px)] w-full flex items-center justify-center p-6 bg-warm-bg text-warm-text-primary animate-fade-in">
      <div className="bg-warm-card border border-warm-border rounded-3xl p-8 sm:p-12 text-center max-w-md w-full shadow-sm">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-warm-text-primary mb-3">Something went wrong</h2>
