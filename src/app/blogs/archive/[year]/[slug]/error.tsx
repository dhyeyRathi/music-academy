  ...
  return (
    <div className='w-full bg-flare-gradient min-h-screen flex items-center justify-center p-20'>
      <div className='bg-black/50 rounded-lg p-10 text-center max-w-md'>
        <h2 className='text-3xl font-bold text-red-500 mb-4'>Post Not Found</h2>
        <p className='text-gray-300 mb-6'>{error.message || 'The blog post you are looking for does not exist'}</p>
        <button
          onClick={() => reset()}
